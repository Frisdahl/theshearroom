...
const Header: React.FC = () => {
  ...
  const [headerState, setHeaderState] = useState<"hero" | "hidden" | "sticky">(
    "hero",
  );
  ...
  return (
    <header ref={headerRef} className={`z-[5000] ${getHeaderClasses()}`}>
      <div className="max-w-[1600px] mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          >
            {/* Logo */}
            <div className="logo">
              <h1 className="text-xl md:text-2xl font-extrabold tracking-widest m-0 text-[#1a1a1a] uppercase font-urbanist">
            ...
            <div className="flex items-center gap-3 md:gap-6">
              <a
                href="#login"
                className="text-[#1a1a1a] font-bold text-sm md:text-base hover:text-[#d4a373] transition-colors duration-300"
              >
                Log ind
              </a>
