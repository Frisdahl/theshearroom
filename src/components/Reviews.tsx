  ...
  const reviews = [
    {
      ...
      rating: "5.0",
      review:
        "Fantastisk service og atmosfære. Jeg er altid tilfreds med min klipning her.",
    },
    {
      image: "/images/2.jpg",
      name: "Mads Nielsen",
      ...
      rating: "4.8",
      review:
        "Meget professionelle barberer. Man føler sig virkelig velkommen og i gode hænder.",
    },
    {
      image: "/images/3.jpg",
      name: "Emma Hansen",
    ...
    },
    {
      ...
      rating: "4.7",
      review:
        "Gode priser og hurtig betjening. Kan varmt anbefales til en hurtig trimning.",
    },
    {
      image: "/images/5.jpg",
      name: "Camilla Møller",
      ...
      rating: "5.0",
      review:
        "Helt vild med resultatet! Min stylist forstod præcis hvad jeg ønskede.",
    },
    {
      image: "/images/6.jpg",
      name: "Thomas Bruun",
      ...
      rating: "4.6",
      review:
        "Solid barbering og god musik. Kommer helt sikkert igen næste gang.",
    },
    {
      image: "/images/7.jpg",
      name: "Julie Andersen",
      ...
      rating: "4.9",
      review:
        "Super dygtige stylister og en meget afslappende oplevelse hver gang.",
    },
    {
      image: "/images/8.jpg",
      ...
      rating: "4.8",
      review:
        "Altid en fornøjelse. De små detaljer gør virkelig en stor forskel her.",
    },
    {
      image: "/images/9.jpg",
      name: "Louise Schmidt",
      ...
      rating: "5.0",
      review:
        "Eksklusiv behandling fra start til slut. Kan ikke forestille mig at gå andre steder hen.",
    },
  ];
      ...
      <div className="container">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <div className="flex items-center justify-center gap-4 md:gap-6 mb-6 h-12 md:h-16">
            ...
            />
            <h2 className="text-4xl md:text-5xl font-bold text-[#1a1a1a] font-urbanist leading-none tracking-tight">
              4.73
            </h2>
            <img
              src="/images/leaf.png"
              alt=""
              className="h-full w-auto object-contain scale-x-[-1] opacity-40"
            />
          </div>
        ...
        <div className="flex flex-col sm:flex-row divide-y sm:divide-y-0 sm:divide-x divide-gray-100 mb-20 max-w-4xl mx-auto">
          {ratings.map((item, index) => (
            <div key={index} className="flex-1 p-6 md:p-8 text-center">
