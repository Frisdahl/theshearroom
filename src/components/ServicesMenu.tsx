      ...
      <div className="max-w-[1600px] mx-auto px-4">
        ...
        <div className="mb-16">
          <div className="flex items-center gap-3 mb-6">
            ...
            <p className="text-[#1a1a1a] text-base font-semibold tracking-[0.2em] uppercase m-0">
              Menu
            </p>
          </div>
          <h2 className="services-menu-title text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#1a1a1a] font-urbanist">
            Tjenester og priser
          </h2>
        </div>
          ...
          <div className="relative bg-white w-full max-w-2xl rounded-3xl p-8 md:p-12 shadow-2xl max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in duration-300">
            ...
            <div className="mb-10">
              <div className="flex items-center gap-3 mb-6">
                ...
                <p className="text-[#1a1a1a] text-xl font-bold tracking-widest uppercase m-0">
                  {selectedCategory}
                </p>
              </div>
              <h3 className="text-3xl md:text-4xl font-extrabold text-[#1a1a1a] font-urbanist">
