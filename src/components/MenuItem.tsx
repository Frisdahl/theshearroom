...
const MenuItem: React.FC<MenuItemProps> = ({ title, description, href, onClick }) => {
  return (
    <a 
      href={href} 
      onClick={onClick}
    ...
    >
      ...
      <div className="overflow-hidden mb-1">
        <p className="menu-item-title text-[#1a1a1a] font-bold text-lg font-serif group-hover:text-[#d4a373] transition-colors uppercase tracking-wide m-0">
          {title}
        </p>
      </div>
