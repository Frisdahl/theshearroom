...
const Hero: React.FC = () => {
  ...
  return (
    <section id="home" className="relative bg-gray-50 overflow-hidden h-screen max-h-screen flex items-stretch">
          ...
          <div className="flex-1 pt-32 lg:pt-36 pb-12 flex flex-col justify-between h-full">
            <div className="flex-1 flex flex-col justify-center">
              <h2 className="text-[#d4a373] text-base uppercase tracking-widest font-bold mb-3 font-sans">
                Velkommen til The Shear Room
              </h2>
              <h1 className="text-4xl lg:text-6xl xl:text-7xl font-extrabold leading-tight text-[#1a1a1a] mb-5 font-serif">
                Ultimativ pleje for <span className="text-[#d4a373]">mænd</span>
              </h1>
              <p className="text-base lg:text-lg text-gray-600 leading-relaxed mb-6 max-w-lg font-sans">
                Førsteklasses klipning, skægtrimning og traditionel barbering leveret af eksperter. Vi forener klassiske teknikker med moderne stil.
              </p>

              {/* Happy Customers Section */}
              <div className="flex items-center gap-4 mb-8">
                <img src="/icons/happy-customer.png" alt="Happy customers" className="h-10 w-auto object-contain" />
              ...
              <div className="mb-6">
                ...
                >
                  ...
                  >
                    <img src="/icons/right-arrow.svg" alt="arrow" className="w-4 h-4 -rotate-45" />
                  </div>
            ...
            <div className="w-full border border-gray-200 rounded-2xl py-8 px-10 flex items-center justify-between bg-white/50 shadow-sm backdrop-blur-sm">
              <div className="flex items-center gap-4">
                <img src="/icons/customer-favourite.svg" alt="favourite" className="w-10 h-10 lg:w-12 lg:h-12" />
              ...
              <div className="flex gap-8 lg:gap-12 items-start">
                <div className="text-center">
                  <h4 className="text-lg lg:text-xl font-bold text-[#1a1a1a] m-0 font-sans leading-none">100%</h4>
                  <p className="text-[9px] text-gray-500 uppercase font-bold mt-2.5 font-sans tracking-wider">Besvarelse</p>
                </div>
                <div className="text-center flex flex-col items-center">
                  <h4 className="text-lg lg:text-xl font-bold text-[#1a1a1a] m-0 font-sans leading-none">4.73</h4>
                  <div className="h-[14px] flex items-center mt-2.5">
                    <img src="/icons/5stars.png" alt="rating" className="h-2.5 lg:h-3" />
                  </div>
                </div>
                <div className="text-center">
                  <h4 className="text-lg lg:text-xl font-bold text-[#1a1a1a] m-0 font-sans leading-none">183</h4>
                  <p className="text-[9px] text-gray-500 uppercase font-bold mt-2.5 font-sans tracking-wider">Anmeldelser</p>
                </div>
              </div>
            </div>
          </div>
